...
@section('seoMeta')
    ...
    <meta name="keywords" content="Discover the key benefits of a hotel and booking management system. Streamline your operations, enhance guest experiences, and improve revenue with powerful software solutions designed for the hospitality industry.">
                    ...
                    <div class="row p-4 g-5 card flex-row">
                        <div class="col-lg-6 px-0 text-center text-lg-start"
                            ...
                            <h1 class="display-5  mt-0  wow animate__animated animate__bounceInDown"
                                ...
                                The Benefits of a Hotel and Booking
                                Management
                                System: Why Laravel and Ather Digital Hub Are the Perfect Choice</h1>
                        ...
                        <div class="col-lg-6 px-0 text-center mt-0 text-lg-start wow animate__animated animate__slideInRight"
                            ...
                            <div class="blog-image-container">
                                <img src="{{ asset('img/blogs/hotel-and-booking-managemeny-system-by-ather-digital-hub.jpg') }}"
                                    alt="blog-image">
                            </div>
                        </div>
                    </div>
