    ...
    <section class="hero reveal-up delay-100">
        <div class="container hero-grid">
            <div class="hero-content">
                <h1 class="hero-title">The Benefits of a Hotel and Booking Management System: Why Laravel and Ather Digital Hub Are the Perfect Choice</h1>
            ...
            <div class="hero-visual reveal-scale delay-300">
                <div class="blog-image-container">
                    <img src="{{ asset('img/blogs/hotel-and-booking-managemeny-system-by-ather-digital-hub.jpg') }}" alt="blog-image">
                </div>
            </div>
        </div>
    </section>
